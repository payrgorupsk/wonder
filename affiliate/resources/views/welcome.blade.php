...
<a href="{{url('/')}}"><span style='width:170px;height:70px; margin-bottom: 10px;background-image:url(https://www.payrchat.com/themes/wowonder/img/logo.png)'></span>
</a></div>
</div>
<br>
...
</div><div class="a-column a-span12 a-spacing-none a-spacing-top-micro"><span class="a-declarative" data-action="ac-welcome-get-started-button" data-ac-welcome-get-started-button="{}"><span class="a-button a-button-primary"><span class="a-button-inner"><a href="{{url('/affiliate_form')}}" class="a-button-text" role="button">Join With Us
