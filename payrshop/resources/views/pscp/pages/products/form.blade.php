                        ...
                        <form >
                            <div class="form-row mb-2">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="product_sku" placeholder="SKU">
                                </div>
                            </div>
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select class="form-control basic" id="subcategory_id" name="subcategory_id">
                                        <option>Select</option>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="product_stock" placeholder="Product Stock">
                                </div>
                            </div>
                            <div class="form-group row mb-2">
                                <div class="n-chk col-md-3">
                                    <label class="new-control new-checkbox new-checkbox-rounded checkbox-primary">
                                      <input type="checkbox" id="payrmall" name="payrmall" class="new-control-input">
                                      <span class="new-control-indicator"></span>Payrmall
                                    </label>
                                </div>
                                <div class="n-chk col-md-3">
                                    <label class="new-control new-checkbox new-checkbox-rounded checkbox-primary">
                                      <input type="checkbox" id="flash_sale" name="flash_sale" class="new-control-input">
                                      <span class="new-control-indicator"></span>Flash Sale
                                    </label>
                                </div>
                                <div class="n-chk col-md-3">
                                    <label class="new-control new-checkbox new-checkbox-rounded checkbox-primary">
                                      <input type="checkbox" id="all_products" name="all_products" class="new-control-input">
                                      <span class="new-control-indicator"></span>All Products
                                    </label>
                                </div>
                                <div class="n-chk col-md-3">
                                    <label class="new-control new-checkbox new-checkbox-rounded checkbox-primary">
                                      <input type="checkbox" id="affiliate" name="affiliate" class="new-control-input">
                            ...
                            <div class="form-group row mb-2">
                                <div class="form-group col-md-4">
                                    ...
                                    <select class="form-control multiselect tagging" id="country" name="country" multiple="multiple">
                                        <option>Select</option>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select class="form-control multiselect tagging" id="payment_getway" name="payment_getway" multiple="multiple">
                                        <option>Select</option>
                                    ...
                                    <div class="n-chk">
                                        <label class="new-control new-checkbox new-checkbox-rounded checkbox-primary">
                                          <input type="checkbox" id="cod" name="cod" class="new-control-input">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select class="form-control multiselect tagging" id="product_delevery" name="product_delevery" multiple="multiple">
                                        <option>Select</option>
                                        <option value="All">All</option>
                            ...
                            <div class="custom-file-container" data-upload-id="product_image">
                                ...
                                <label class="custom-file-container__custom-file" >
                                    <input type="file" id="product_image" name="product_image" class="custom-file-container__custom-file__custom-file-input" multiple>
