                                    ...
                                    <tbody>
                                        @foreach ($products as $key => $product)
                                          <tr>
                                            ...
                                            <td><button class="btn btn-primary mx-2"><i class="fa fa-eye-open"></i> View</button><button class="btn btn-primary mx-2"><i class="fa fa-pencil"></i> Edit</button><button class="btn btn-danger mx-2"><i class="fa fa-trash"></i> Delete</button></td>
                                        </tr>
                                        @endforeach
