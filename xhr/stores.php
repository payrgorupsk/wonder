...
if ($f == 'stores') {
    if ($s == 'create_store') {
        if (!empty($_POST['store_name']) && ($_POST['store_name'] == 'wowonder' || $_POST['store_name'] == 'sunshine' || $_POST['store_name'] == $wo['config']['theme']) ) {
            $_POST['store_name'] = "";
        }
        if (empty($_POST['store_name']) || empty($_POST['store_title']) || empty(Wo_Secure($_POST['store_title'])) || Wo_CheckSession($hash_id) === false) {
        ...
        if (empty($errors)) {
            ...
            $re_page_data  = array(
                ...
                'store_category' => Wo_Secure($_POST['store_category']),
